...
namespace Sitecore.SharedModules.ImageCropping.Shell.Applications.Media
{
    public class ExtendedImagePropertiesPage : DialogPage
    {
        ...
        /// <returns></returns>
        /// <exception cref="System.NotImplementedException"></exception>
        private string GetCoordinateValue(Sitecore.Shell.Applications.ContentEditor.XmlValue xmlValue, string coordinate)
        {
